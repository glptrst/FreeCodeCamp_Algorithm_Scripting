...
function palindrome(str) {
  //remove non alphanumeric char and make lower case
  var str2 = str.replace(/[^0-9a-z]/gi, '').toLowerCase();
  // now create reversed string
  var reversed =  str2.split("").reverse().join("");
